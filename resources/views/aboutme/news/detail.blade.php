		...
		<div class="content">
			<div id="blog" class="blogdt">
				...
				<ul>
					...
					<li>
						<div class="article">
							<h3><a href="{{route('aboutme.detail')}}" class="more">Gia Huy dự thi "Tài năng lập trình trẻ 2016"</a></h3>
							<p>
								Trang web báo chí Đà Nẵng, cập nhật những tin tức liên quan đến kinh tế, chính trị,  giải trí Việt Nam...								
							</p>
						</div>
			...
			<div id="sidebar">
				...
				<div class="awards">
					<h3>Quảng cáo</h3>
					<a href="#" class="first">
						<img src="/templates/aboutme/images/hehocgi.png" alt="" />
					</a>
					<a href="#" class="first">
						<img src="/templates/aboutme/images/java.png" alt="" />
					</a>
				</div>
			</div>
